    ...
    public class ChatView : xk_View
    {
        ...
        private IEnumerator InitData()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                if (contentId == 2)
                {
                    mChatInfo.content = "<xk_1,emoj_2,50,50>sddddddddddddddddddddddddddddddddddddddddddddddd<xk_2,#1,我是你妈>";
                }
                else
                {
                    mChatInfo.content = "sdfsdfsadfadddddddddddddddddddddddddddsasfdasfd<xk_2,#1,我是你妈>dfsdssssssssssssssssdddd<xk_2,#1,我是你妈>ddddddddddddsdfsdd<xk_2,#1,我是你妈>dddddddddddddddddddddddd";
                }
